                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    ...
                                                    <input type="text" placeholder="Post Title" name="p_title" class="form-control" id="p_title" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    ...
                                                    <input type="text" placeholder="Post Slug" name="p_slug" class="form-control" id="p_slug" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
